    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1 text-gray-800 fw-bold">Tujuan Tabungan</h1>
                    <p class="text-muted">Kelola semua tujuan tabungan Anda</p>
                </div>
                <a href="{{ route('goals.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Tambah Tujuan
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-body py-3">
                    <form action="{{ route('goals.index') }}" method="GET" class="row g-3 align-items-center">
                        <div class="col-md-6">
                            <input type="text" name="search" class="form-control" placeholder="Cari tujuan tabungan..." 
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card savings-card shadow-sm h-100 border-0">
                    <div class="card-header position-relative p-0 border-0">
                        <img src="{{ asset($goal->gambar) }}" class="card-img-top" alt="{{ $goal->nama_barang }}" 
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('goals.edit', $goal->id) }}" class="btn btn-outline-warning btn-sm">
                                <i class="bi bi-pencil-square me-1"></i>Edit
                            </a>
                            <form action="{{ route('goals.destroy', $goal->id) }}" method="POST" 
                                  onsubmit="return confirm('Yakin ingin menghapus tujuan tabungan ini?')" class="d-inline">
                                @csrf
                                @method('DELETE')
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body text-center py-5">
                        <div class="empty-state-icon mb-4">
                            <i class="bi bi-bullseye fs-1 text-muted opacity-50"></i>
                        </div>
                        <h4 class="text-muted mb-3">Belum ada tujuan tabungan</h4>
                        <p class="text-muted mb-4">Mulai buat tujuan tabungan pertama Anda</p>
                        <a href="{{ route('goals.create') }}" class="btn btn-primary">
